...
Chưa chạy notebook Colab vì bước này cần GPU T4 và một phiên Google Colab. Chỉ sau khi chạy `notebooks/day4_pose_finetune_yolo26.ipynb` mới có thể tạo số liệu thật trong `outputs/eval_model.json`.
